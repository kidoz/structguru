...
- **[Integrations Guide](integrations.md)** — Detailed instructions for setting up frameworks.
- **[Full-stack Example](https://github.com/kidoz/structguru/blob/main/examples/full_stack_fastapi/main.py)** — FastAPI + Celery + SQLAlchemy in action.
